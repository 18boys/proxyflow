/**
 * proxyflow Web SDK — TypeScript 类型定义
 */

export interface proxyflowConfig {
  /** proxyflow 后端地址，如 "http://localhost:9000" */
  serverUrl: string;
...
export interface proxyflowWebSDK {
  readonly version: string;

  /**
   * 初始化 SDK，必须在任何请求调用前执行。
   * 推荐在应用入口（如 main.ts / index.js）的顶层调用。
   */
...
declare const proxyflow: proxyflowWebSDK;
export default proxyflow;
export = proxyflow;

declare global {
  interface Window {
    proxyflow: proxyflowWebSDK;
  }
}
