/**
 * proxyflow-relay.mjs
 * 通用 Dev Server / BFF 转发工具：将请求打包转发到 Proxyflow /api/relay
 *
...
/**
 * Vite 插件辅助函数：一行挂载到 Vite
 * @param {Object} options
 * @param {string} options.targetEnv - 真实目标环境
 * @param {string} options.sessionId - 设备 Session ID
 * @param {string} [options.proxyflowUrl] - Proxyflow 服务地址，默认 'http://172.31.0.8:9000'
 * @param {string} [options.prefix] - 拦截的前缀，默认 '/api'
 */
